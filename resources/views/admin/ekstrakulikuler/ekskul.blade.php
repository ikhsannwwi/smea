        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              {{-- <td>{{$no++}}</td> --}}
              <td>
                <img  src="{{asset('images/foto-ekskul/'.$row->ekskul_photo)}}">
              ...
              <td class="">
                ...
                <a href="#"  data-id="{{$row->id}}" class="delete" data-nama="{{$row->ekskul_judul}}"  id="delete"><i class='bx bx-folder-minus bx-sm bx-tada-hover' ></i></a>
              </td>
            </tr>
            @endforeach
